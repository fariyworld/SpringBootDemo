package com.mace.redis.service.impl;
...
/**
 * description: Redis支持五种数据类型：
 * string（字符串），hash（哈希），list（列表），set（集合）及zset(sorted set：有序集合)。
 * <br />
 * Created by mace on 17:01 2018/6/2.
 */
...
//-----------------     string     -----------------
    ...
    public void setForTimeSeconds(String key,String value,long time){
    ...
    public String getStrValByStrKey(String key){
