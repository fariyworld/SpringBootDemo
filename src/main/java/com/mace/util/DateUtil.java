 ...
 * description:
 * <br />
 * Created by mace on 14:46 2018/6/1.
 */
@Slf4j
public class DateUtil {
     ...
     */
    public static final String pattern_time_sencond = "yyyy-MM-dd HH:mm:ss.SSS";

    /**
     * description: 默认按照 yyyy-MM-dd HH:mm:ss.SSS 进行日期格式化
     * <br /><br />
     * create by mace on 2018/6/1 14:53.
     * @param date  日期
     * @return: java.lang.String    输出格式为 yyyy-MM-dd HH:mm:ss 的字符串
     */
    public static String formatDate(Date date) {
        return formatDate(date, pattern_time_sencond);
    }


    /**
     * description: 按照给定的patter进行日期格式化
     * <br /><br />
     * create by mace on 2018/6/1 14:48.
     * @param date      日期
     * @param pattern   格式化类型
    ...
    /**
     * description: 按 yyyy-MM-dd HH:mm:ss 格式解析日期字符串
     * <br /><br />
     * create by mace on 2018/6/1 14:54.
     * @param dateStr   日期字符串
    ...
    /**
     * description: 按指定的pattern格式解析日期字符串
     * <br /><br />
     * create by mace on 2018/6/1 14:54.
     * @param dateStr
     * @param pattern
    ...
    public static Date parseString(String dateStr, String pattern) {
        ...
        try {
            ...
            log.error(dateStr + "转换成日期失败，可能是不符合格式：" + pattern);
        }
        return null;
    }
